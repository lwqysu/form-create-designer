    ...
    com: {
        ...
        fcInput: {
            ...
            event: {
                ...
                enter: 'Triggered when input is completed and enter is confirmed',
                'click-error-icon': 'Triggered when the error icon is clicked',
            },
            options: {
                text: 'Text',
                number: 'Number',
            ...
            props: {
                ...
                visible: 'Visible',
                requisite: 'Required',
                promptInformation: 'Validation error message',
                symbol: 'Required symbol',
                isSql: 'Enable SQL filtering',
